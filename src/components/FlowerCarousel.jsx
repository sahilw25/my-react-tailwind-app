...
const images = [
  ...
  { src: "${import.meta.env.BASE_URL}QPimage2.png", title: "Garden Raised", desc: "Naturally nurtured for vibrant bloom." },
  { src: "${import.meta.env.BASE_URL}QPimage3.png", title: "Good harvest", desc: "A tradition of natural growth and responsible farming." },
  { src: "${import.meta.env.BASE_URL}QPimage4.jpg", title: "Season Bright", desc: "Bold flowers harvested with care." },
  { src: "${import.meta.env.BASE_URL}QPimage5.jpg", title: "Bed of Petals", desc: "Lovingly cultivated to last longer." }
];
